      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 20px" }}>
        <div style={{ background: "#fff", borderRadius: 16, padding: "32px 24px", border: "1px solid rgba(0,0,0,0.06)" }}>
          ...
          <div style={sectionStyle}>
            ...
            <p style={pStyle}>이 약관은 생글생글(이하 &quot;플랫폼&quot;)이 제공하는 교사 업무 지원 서비스의 이용 조건과 절차를 규정함을 목적으로 합니다.</p>
          </div>
          <div style={sectionStyle}>
            <h2 style={h2Style}>제2조 (서비스 내용)</h2>
            <p style={pStyle}>플랫폼은 교사의 업무를 지원하기 위해 다음과 같은 기능을 제공하며, 향후 추가 기능이 포함될 수 있습니다.<br /><br />• 에듀테크 개인정보 동의서 자동 생성 및 공유·다운로드<br />• 생활기록부 작성 도우미<br />• 공문 본문 작성 도우미<br />• 기타 교사 업무 지원 기능</p>
          </div>
          <div style={sectionStyle}>
            <h2 style={h2Style}>제3조 (가입 및 로그인)</h2>
            <p style={pStyle}>일부 기능의 이용을 위해 카카오 계정을 통한 로그인이 필요합니다. 로그인 시 카카오 고유 ID만 수집하며, 닉네임·이메일·프로필사진 등 추가 개인정보는 수집하지 않습니다.</p>
          </div>
          <div style={sectionStyle}>
            <h2 style={h2Style}>제4조 (이용자의 의무)</h2>
            <p style={pStyle}>이용자는 플랫폼을 교육 목적에 맞게 사용해야 하며, 부적절한 내용을 등록해서는 안 됩니다. 부적절한 등록 내용은 관리자에 의해 삭제될 수 있습니다.</p>
          </div>
          <div style={sectionStyle}>
            <h2 style={h2Style}>제5조 (면책)</h2>
            <p style={pStyle}>플랫폼에서 AI가 생성한 결과물(동의서, 생활기록부 문장, 공문 등)은 참고용이며, 최종 사용 전 내용을 반드시 확인하시기 바랍니다. 플랫폼은 AI 생성 결과물의 법적 정확성을 보장하지 않으며, 이로 인한 책임을 지지 않습니다.</p>
          </div>
          <div style={sectionStyle}>
            <h2 style={h2Style}>제6조 (계정 삭제)</h2>
            <p style={pStyle}>이용자는 언제든지 플랫폼 내 계정 삭제 기능을 통해 탈퇴할 수 있으며, 탈퇴 시 저장된 카카오 고유 ID는 즉시 삭제됩니다.</p>
          </div>
          <div>
            <h2 style={h2Style}>제7조 (약관 변경)</h2>
            <p style={pStyle}>본 약관은 필요 시 변경될 수 있으며, 변경 시 플랫폼 내 공지를 통해 안내합니다.</p>
          </div>
        </div>
      </div>
    </div>
