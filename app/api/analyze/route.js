...
{
  "consent_needed": true,
  "name": "서비스명 (실제 웹사이트/앱에서 사용하는 이름, 법인명 병기 권장. 예: Padlet (Wallwisher, Inc.))",
...
- 예: 약관에 "Wallwisher, Inc. Service"라고 되어 있어도 → "Padlet (Wallwisher, Inc.)"
...
case_type 판별 기준:
- "foreign_no_signup": 국외기업(본사/서버 해외 또는 국외이전 조항 있음) + 교사가 일괄 계정 생성하거나 학생 직접 가입 불필요
- "foreign_with_signup": 국외기업 + 14세 미만 회원가입 시 법정대리인 동의 필요
- "domestic_no_signup": 국내기업(본사·서버 국내, 국외이전 조항 없음) + 교사 일괄 계정 생성 또는 학생 직접 가입 불필요
- "domestic_with_signup": 국내기업 + 14세 미만 회원가입 시 법정대리인 동의 필요`;
